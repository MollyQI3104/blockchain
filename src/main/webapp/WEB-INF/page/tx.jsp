...
<script type="text/javascript">
    ...
    var contextPath="${pageContext.request.contextPath}";
            ...
            $("#button1").on('click', function () {
                var targetUrl = contextPath+"/user/serviceUserCompleteScan";
                var targetUrl2 =contextPath+"/user/queryPublishWaitingService";
                var recordID = getQueryString("recordID");
                            ...
                            $.ajax({
                                ...
                                cache: false,
                                url: targetUrl,
                                data: "qrcode=" + recordID + "&recordID=" + recordID,
