...
<div class="page">
    ...
    <div class="page__bd" style="height: 100%;">
            ...
            <div class="weui-navbar" style="position:fixed;">
                <div class="weui-navbar__item weui-bar__item_on"id="navbar1" style="color: #20B2AA;">
                    已申请
                </div>
                ...
                <div class="weui-panel__bd">
                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__bd">
                            <p class="weui-tabbar__label" style="float:right;color:#20B2AA;font-size:16px">等待接受申请</p>
                        </div>
                    </div>
                </div>
