                ...
                <div class="weui-panel__bd">
                    <div class="weui-media-box weui-media-box_appmsg">
                        ...
                        <div class="weui-media-box__bd">
                            <div class="weui-flex">
                                <div class="weui-flex__item"diaplay="none"><h4 class="weui-media-box__title">申请者:<%out.print(recordDetailList.get(i).getApplyUser().getName()+" (信誉值"+recordDetailList.get(i).getApplyUser().getEvaluation()+"星)");%></h4></div>
                            ...
                            <p class="weui-media-box__desc">物品最迟归还时间: <%out.print(recordDetailList.get(i).getOrder().getEstimateReturntime());%></p>

                            <p class="weui-media-box__desc" style="color: #20B2AA;">申请者微信ID: <%out.print(recordDetailList.get(i).getApplyUser().getWechat());%></p>
                        </div>
                    </div>
                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__bd">
                            <div class="weui-flex">
                                ...
                                <div class="weui-flex__item"display="none"></div>
                                <div class="weui-flex__item"display="none"></div>
                            <div class="weui-flex__item"><a href="${pageContext.request.contextPath}/record/handleApplicantRecord?handle=refuse&recordID=<%out.print(recordDetailList.get(i).getOrder().getStatus());%>&PublishID=<%out.print(recordDetailList.get(i).getOrder().getPublishid());%>&Applyuser=<%out.print(recordDetailList.get(i).getOrder().getApplyuserid());%>" class="weui-btn weui-btn_mini weui-btn_default" style="float:right;">拒绝</a></div>
                            <div class="weui-flex__item"><a href="${pageContext.request.contextPath}/record/handleApplicantRecord?handle=confirm&recordID=<%out.print(recordDetailList.get(i).getOrder().getStatus());%>&PublishID=<%out.print(recordDetailList.get(i).getOrder().getPublishid());%>&Applyuser=<%out.print(recordDetailList.get(i).getOrder().getApplyuserid());%>" class="weui-btn weui-btn_mini weui-btn_primary" style="float:right;">接受</a></div>
                        </div>
